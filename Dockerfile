...
# RUN echo "ServerName test-saka-ec-01.onrender.com:80" | tee /etc/httpd/conf/httpd.conf
# RUN a2enconf httpd
 RUN echo "ServerName test-saka-ec-01.onrender.com:80" | tee /etc/apache2/conf-available/fqdn.conf
 RUN a2enconf fqdn
